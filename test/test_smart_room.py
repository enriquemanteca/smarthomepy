...
class TestSmartRoom(unittest.TestCase):
    ...
    def test_turn_on_light_when_room_occupied_and_not_enough_light(self,
                                                                   led: Mock,photoresistor: Mock,sensor: Mock):
        photoresistor.return_value = False
        sensor.return_value=True
        smart_room = SmartRoom()
        ...
        led.assert_called_once_with(smart_room.LED_PIN,True)

    @patch.object(GPIO, "input")
    @patch.object(GPIO, "input")
    @patch.object(GPIO, "output")
    def test_turn_off_light_when_room_not_occupied_and_not_enough_light(self,
                                                                   led: Mock, photoresistor: Mock, sensor: Mock):
        sensor.return_value = False
        photoresistor.return_value = False
        smart_room = SmartRoom()
    ...
    @patch.object(GPIO, "input")
    @patch.object(GPIO, "output")
    def test_turn_off_light_when_room_not_occupied_and_enough_light(self,
                                                                        led: Mock, photoresistor: Mock, sensor: Mock):
        sensor.return_value = False
        photoresistor.return_value = True
        smart_room = SmartRoom()
    ...
    @patch.object(GPIO, "input")
    @patch.object(GPIO, "output")
    def test_turn_off_light_when_room_occupied_and_enough_light(self,
                                                                        led: Mock, photoresistor: Mock, sensor: Mock):
        sensor.return_value = True
        photoresistor.return_value = True
        smart_room = SmartRoom()
